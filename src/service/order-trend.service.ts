...
export class OrderTrendService {
  constructor(
    @InjectRepository(Delnotetrends001mb)
    private readonly orderRepository: Repository<Delnotetrends001mb>,
    @InjectRepository(Delnotetrends001hb)
    private readonly orderhbRepository: Repository<Delnotetrends001hb>
  ) {}

  async create(
    delnotetrendsDTO: DelnotetrendsDTO
  ): Promise<Delnotetrends001mb> {
    const delnotetrends001mb = new Delnotetrends001mb();
    delnotetrends001mb.setProperties(delnotetrendsDTO);
    return this.orderRepository.save(delnotetrends001mb);
  }
  ...
  async update(
    ...
    await this.orderRepository.update(
      { dntrendId: delnotetrends001mb.dntrendId },
      delnotetrends001mb
    );
  ...
  async remove(id: string): Promise<void> {
    let orderTrend = this.orderRepository.findOne(id);
    let delnotetrends001hb = new Delnotetrends001hb();
    delnotetrends001hb.setProperties(await orderTrend);
    this.orderhbRepository.save(delnotetrends001hb);
    await this.orderRepository.delete(id);
  }

  async downloadPdf(@Req() request: Request, @Res() response: Response) {
    var html = fs.readFileSync("./html_pdf/order-trend.html", "utf8");
    let orderTrend: any[] = await this.orderRepository.find();
    ...
    var document = {
      ...
      path: path.join(`./pdf/orderTrend.pdf`),
      type: "",
    };
    var options = {
      format: "A3",
      ...
      pdf
        ...
        .then((pathRes) => {
          ...
          response.writeHead(200, {
            "Content-Disposition": "attachment;filename=" + "orderTrend.pdf",
  ...
  async downloadExcel(@Req() request: Request, @Res() response: Response) {
    let orderTrend = await this.orderRepository.find();

    if (orderTrend.length < 0) {
      return;
    } else {
      let workbook = new excel.Workbook();
      let worksheet = workbook.addWorksheet("orderTrend");
      ...
      worksheet.getCell("A1:AG1").alignment = {
        vertical: "middle",
        horizontal: "center",
      };

      worksheet.mergeCells("A2:AG2");
      worksheet.getCell("A2:AG2").value = "Order Trend Analytic";
      worksheet.getCell("A2:AG2").font = {
        size: 16,
        bold: true,
      };
      worksheet.getCell("A2:AG2").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("R3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("S3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("X3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("Z3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AA3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AB3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AC3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AD3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AE3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AF3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      for (let i = 0; i < orderTrend.length; i++) {
        let temp = i + 4;

        worksheet.mergeCells("A" + temp);
        worksheet.getCell("A" + temp).value = orderTrend[i].dntrendId;
        ...
        worksheet.getCell("B" + temp).value = orderTrend[i].itemCode;
        ...
        worksheet.getCell("C" + temp).value = orderTrend[i].period;
        ...
        worksheet.getCell("D" + temp).value = orderTrend[i].basedOn;
        ...
        worksheet.getCell("E" + temp).value = orderTrend[i].fiscalYear;
        ...
        worksheet.getCell("F" + temp).value = orderTrend[i].company;
        ...
        worksheet.getCell("G" + temp).value = orderTrend[i].janQty;
        ...
        worksheet.getCell("H" + temp).value = orderTrend[i].janAmt;
        ...
        worksheet.getCell("I" + temp).value = orderTrend[i].febQty;
        ...
        worksheet.getCell("J" + temp).value = orderTrend[i].febAmt;
        ...
        worksheet.getCell("K" + temp).value = orderTrend[i].marQty;
        ...
        worksheet.getCell("L" + temp).value = orderTrend[i].marAmt;
        ...
        worksheet.getCell("M" + temp).value = orderTrend[i].aprQty;
        ...
        worksheet.getCell("N" + temp).value = orderTrend[i].aprAmt;
        ...
        worksheet.getCell("O" + temp).value = orderTrend[i].mayQty;
        ...
        worksheet.getCell("P" + temp).value = orderTrend[i].mayAmt;
        ...
        worksheet.getCell("Q" + temp).value = orderTrend[i].junQty;
        ...
        worksheet.getCell("R" + temp).value = orderTrend[i].junAmt;
        worksheet.getCell("R" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("R" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("S" + temp);
        worksheet.getCell("S" + temp).value = orderTrend[i].julQty;
        worksheet.getCell("S" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("S" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("T" + temp);
        worksheet.getCell("T" + temp).value = orderTrend[i].julAmt;
        worksheet.getCell("T" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("T" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("U" + temp);
        worksheet.getCell("U" + temp).value = orderTrend[i].augQty;
        worksheet.getCell("U" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("U" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("V" + temp);
        worksheet.getCell("V" + temp).value = orderTrend[i].augAmt;
        worksheet.getCell("V" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("V" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("W" + temp);
        worksheet.getCell("W" + temp).value = orderTrend[i].sepQty;
        worksheet.getCell("W" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("W" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("X" + temp);
        worksheet.getCell("X" + temp).value = orderTrend[i].sepAmt;
        worksheet.getCell("X" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("X" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("Y" + temp);
        worksheet.getCell("Y" + temp).value = orderTrend[i].octQty;
        worksheet.getCell("Y" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("Y" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("Z" + temp);
        worksheet.getCell("Z" + temp).value = orderTrend[i].octAmt;
        worksheet.getCell("Z" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("Z" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AA" + temp);
        worksheet.getCell("AA" + temp).value = orderTrend[i].novQty;
        worksheet.getCell("AA" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AA" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AB" + temp);
        worksheet.getCell("AB" + temp).value = orderTrend[i].novAmt;
        worksheet.getCell("AB" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AB" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AC" + temp);
        worksheet.getCell("AC" + temp).value = orderTrend[i].decQty;
        worksheet.getCell("AC" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AC" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AD" + temp);
        worksheet.getCell("AD" + temp).value = orderTrend[i].decAmt;
        worksheet.getCell("MAD" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AD" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AE" + temp);
        worksheet.getCell("AE" + temp).value = orderTrend[i].totalQty;
        worksheet.getCell("AE" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AE" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AF" + temp);
        worksheet.getCell("AF" + temp).value = orderTrend[i].totalAmt;
        worksheet.getCell("AF" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AF" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AG" + temp);
        worksheet.getCell("AG" + temp).value = orderTrend[i].augQtyt;
        worksheet.getCell("AG" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AG" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };
      }
