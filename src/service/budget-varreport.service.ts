...
export class
    ...
    constructor(@InjectRepository(Budgetvarreport001mb) private readonly budgetVarRepository: Repository<Budgetvarreport001mb>,
        @InjectRepository(Budgetvarreport001hb) private readonly budgetVarhbRepository: Repository<Budgetvarreport001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let budgetVar = this.budgetVarRepository.findOne(id);
        let budgetvarreport001hb = new Budgetvarreport001hb();
        budgetvarreport001hb.setProperties((await budgetVar));
        this.budgetVarhbRepository.save(budgetvarreport001hb);
        await this.budgetVarRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/budgetVariancerep.html", "utf8");
