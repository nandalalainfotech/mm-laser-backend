...
export class AppraisalService {
    ...
    constructor(@InjectRepository(Appraisal001mb) private readonly appraisalRepository: Repository<Appraisal001mb>,
        @InjectRepository(Appraisal001hb) private readonly appraisalhbRepository: Repository<Appraisal001hb>) { }
    ...
    async remove(id: number): Promise<void> {
        let appraisal = this.appraisalRepository.findOne(id);
        let appraisal001hb = new Appraisal001hb();
        appraisal001hb.setProperties((await appraisal));
        this.appraisalhbRepository.save(appraisal001hb);
        await this.appraisalRepository.delete(id);
    }


    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/appraisal.html", "utf8");
