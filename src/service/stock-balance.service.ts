...
export class StockBalanceService {
    constructor(@InjectRepository(Stkrepbalance001hb) private readonly stockBalancehbRepository: Repository<Stkrepbalance001hb>,
                @InjectRepository(Stkrepbalance001mb) private readonly stockBalanceRepository: Repository<Stkrepbalance001mb>,) { }

    async create(stkrepbalanceDTO: StkrepbalanceDTO): Promise<Stkrepbalance001mb> {
        const stkrepbalance001mb = new Stkrepbalance001mb();
        stkrepbalance001mb.setProperties(stkrepbalanceDTO);stkrepbalance001mb
        return this.stockBalanceRepository.save(stkrepbalance001mb);
    }

    async update(stkrepbalanceDTO: StkrepbalanceDTO): Promise<Stkrepbalance001mb> {
        const stkrepbalance001mb = new Stkrepbalance001mb();
        stkrepbalance001mb.setProperties(stkrepbalanceDTO);
        await this.stockBalanceRepository.update({ stbalId: stkrepbalance001mb.stbalId }, stkrepbalance001mb);
        return stkrepbalance001mb;
    }

    async findAll(): Promise<Stkrepbalance001mb[]> {
        return this.stockBalanceRepository.find();
    }

    findOne(id: string): Promise<Stkrepbalance001mb> {
        return this.stockBalanceRepository.findOne(id);
    }

    async remove(id: number): Promise<void> {
        let stkrepbalance = this.stockBalanceRepository.findOne(id);
        let stkrepbalance001hb = new Stkrepbalance001hb();
        stkrepbalance001hb.setProperties((await stkrepbalance));
        this.stockBalancehbRepository.save(stkrepbalance001hb);
        await this.stockBalanceRepository.delete(id);
    }


    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/stockBalance.html", "utf8");
        let stockBalance: any[] = await this.stockBalanceRepository.find();
        ...
        var document = {
            ...
            path: path.join(`./pdf/stockBalance.pdf`),
            type: "",
        };
        var options = {
            format: "A3",
        ...
        if (stockBalance.length < 0) {
            ...
            pdf.create(document, options).then((pathRes) => {
                ...
                response.writeHead(200, {
                    "Content-Disposition": "attachment;filename=" + "stockBalance.pdf",
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        let stockBalance = await this.stockBalanceRepository.find();
        ...
        if (stockBalance.length < 0) {
            ...
            let worksheet = workbook.addWorksheet('stockBalance');
            ...
            worksheet.getCell('A2:P2').value = "Add New Stock balance";
            ...
            worksheet.getCell('G3').value = "Opening Quantity";
            ...
            worksheet.getCell('H3').value = "Opening Value";
            ...
            worksheet.getCell('I3').value = "InQuantity";
            ...
            worksheet.getCell('J3').value = "Out Quantity";
            ...
            worksheet.getCell('K3').value = "Out Value";
            ...
            worksheet.getCell('L3').value = "Balance Quantity";
            ...
            worksheet.getCell('M3').value = "Balance Value";
            ...
            worksheet.getCell('N3').value = "Valuation Rate";
            ...
            worksheet.getCell('O3').value = "Company";
            ...
            worksheet.getCell('P3').value = "Description";
            ...
            for (let i = 0; i < stockBalance.length; i++) {
                ...
                worksheet.getCell('A' + temp).value = stockBalance[i].stbalId;
                ...
                worksheet.getCell('B' + temp).value = stockBalance[i].itemCode;
                ...
                worksheet.getCell('C' + temp).value = stockBalance[i].itemGroup;
                ...
                worksheet.getCell('D' + temp).value = stockBalance[i].brand;
                ...
                worksheet.getCell('E' + temp).value = stockBalance[i].wareHouse;
                ...
                worksheet.getCell('F' + temp).value = stockBalance[i].stkUom;
                ...
                worksheet.getCell('G' + temp).value = stockBalance[i].openingQty;
                ...
                worksheet.getCell('H' + temp).value = stockBalance[i].openingValue;
                ...
                worksheet.getCell('I' + temp).value = stockBalance[i].inQty;
                ...
                worksheet.getCell('J' + temp).value = stockBalance[i].outQty;
                ...
                worksheet.getCell('K' + temp).value = stockBalance[i].outValue;
                ...
                worksheet.getCell('L' + temp).value = stockBalance[i].balanceQty;
                ...
                worksheet.getCell('M' + temp).value = stockBalance[i].balanceValue;
                ...
                worksheet.getCell('N' + temp).value = stockBalance[i].valuationRate;
                ...
                worksheet.getCell('O' + temp).value = stockBalance[i].company;
                ...
                worksheet.getCell('P' + temp).value = stockBalance[i].description;
