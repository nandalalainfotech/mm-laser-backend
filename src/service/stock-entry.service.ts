...
export class StockEntryService {
    ...
    constructor (@InjectRepository(Stktransentry001hb) private readonly stockEntryhbRepository: Repository<Stktransentry001hb>,
                 @InjectRepository(Stktransentry001mb) private readonly stockEntryRepository: Repository<Stktransentry001mb>) {}
    ...
    async remove(id: number): Promise<void> {
        let stktransentry = this.stockEntryRepository.findOne(id);
        let stktransentry001hb = new Stktransentry001hb();
        stktransentry001hb.setProperties((await stktransentry));
        this.stockEntryhbRepository.save(stktransentry001hb);
        await this.stockEntryRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/stockEntry.html", "utf8");
