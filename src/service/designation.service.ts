...
export class DesignationService {
    ...
    constructor(@InjectRepository(Designation001mb) private readonly designationRepository: Repository<Designation001mb>,
        @InjectRepository(Designation001hb) private readonly designationhbRepository: Repository<Designation001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let designation = this.designationRepository.findOne(id);
        let designation001hb = new Designation001hb();
        designation001hb.setProperties((await designation));
        this.designationhbRepository.save(designation001hb);
        await this.designationRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/designation.html", "utf8");
