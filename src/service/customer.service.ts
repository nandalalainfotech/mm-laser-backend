...
export class CustomerService {
    constructor(@InjectRepository(Customerdetails001mb) private readonly customerRepository: Repository<Customerdetails001mb>,
        @InjectRepository(Customerdetails001hb) private readonly customerhbRepository: Repository<Customerdetails001hb>,) { }
    ...
    async create(customerdetailsDTO: CustomerdetailsDTO): Promise<Customerdetails001mb> {
        ...
        return this.customerRepository.save(customerdetails001mb);
    }

    async update(customerdetailsDTO: CustomerdetailsDTO): Promise<Customerdetails001mb> {
        const customerdetails001mb = new Customerdetails001mb();
        customerdetails001mb.setProperties(customerdetailsDTO);
        await this.customerRepository.update({ id: customerdetails001mb.id }, customerdetails001mb);
    ...
    async remove(id: string): Promise<void> {
        let Customerdetails = this.customerRepository.findOne(id);
        let customerdetails001hb = new Customerdetails001hb();
        customerdetails001hb.setProperties((await Customerdetails));
        this.customerhbRepository.save(customerdetails001hb);
        await this.customerRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/customer.html", "utf8");
        let customer: any[] = await this.customerRepository.find();
        ...
        var document = {
            ...
            path: path.join(`./pdf/customer.pdf`),
            type: "",
        };
        var options = {
            format: "A3",
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        if (customer.length < 0) {
            ...
            { key: 'P', width: 30.0 }, { key: 'Q', width: 20.0 }];
            ...
            for (let i = 0; i < customer.length; i++) {
                ...
                worksheet.getCell('A' + temp).value = customer[i].id;
                ...
                worksheet.getCell('B' + temp).value = customer[i].customerid;
                ...
                worksheet.getCell('C' + temp).value = customer[i].customername;
                ...
                worksheet.getCell('D' + temp).value = customer[i].customergroup;
                ...
                worksheet.getCell('E' + temp).value = customer[i].addressline1;
                ...
                worksheet.getCell('F' + temp).value = customer[i].addressline2;
                ...
                worksheet.getCell('G' + temp).value = customer[i].city;
                ...
                worksheet.getCell('H' + temp).value = customer[i].state;
                ...
                worksheet.getCell('I' + temp).value = customer[i].postalcode;
                ...
                worksheet.getCell('J' + temp).value = customer[i].country;
                ...
                worksheet.getCell('K' + temp).value = customer[i].isprimaryaddress;
                ...
                worksheet.getCell('L' + temp).value = customer[i].firstname;
                ...
                worksheet.getCell('M' + temp).value = customer[i].lastname;
                ...
                worksheet.getCell('N' + temp).value = customer[i].phone;
                ...
                worksheet.getCell('O' + temp).value = customer[i].mobilenumber;
                ...
                worksheet.getCell('P' + temp).value = customer[i].emailid;
                ...
                worksheet.getCell('Q' + temp).value = customer[i].isprimarycontact;
