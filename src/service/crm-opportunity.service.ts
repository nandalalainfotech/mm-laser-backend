...
import { CrmspoppoDTO } from "../dto/Crmspoppo.dto";import { Crmspoppo001hb } from "../entity/Crmspoppo001hb";
...
export class CrmOpportunityService {
    ...
    constructor(@InjectRepository(Crmspoppo001mb) private readonly crmOpportunityRepository: Repository<Crmspoppo001mb>,
        @InjectRepository(Crmspoppo001hb) private readonly crmOpportunityhbRepository: Repository<Crmspoppo001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let Crmspoppo = this.crmOpportunityRepository.findOne(id);
        let crmspoppo001hb = new Crmspoppo001hb();
        crmspoppo001hb.setProperties((await Crmspoppo));
        this.crmOpportunityhbRepository.save(crmspoppo001hb);
        await this.crmOpportunityRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/crmOpportunity.html", "utf8");
