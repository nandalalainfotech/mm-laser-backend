...
export class PurRecptTrendService {
    ...
    constructor (@InjectRepository(Purecpttrend001hb) private readonly purRecpthbRepository: Repository<Purecpttrend001hb>,
                 @InjectRepository(Purecpttrend001mb) private readonly purRecptRepository: Repository<Purecpttrend001mb>) {}
    ...
    async remove(id: number): Promise<void> {
        let purecpttrend = this.purRecptRepository.findOne(id);
        let purecpttrend001hb = new Purecpttrend001hb();
        purecpttrend001hb.setProperties((await purecpttrend));
        this.purRecpthbRepository.save(purecpttrend001hb);
        await this.purRecptRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/purRecpt.html", "utf8");
