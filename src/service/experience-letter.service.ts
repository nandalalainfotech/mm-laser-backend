...
export class ExperienceLetterService {
    constructor(@InjectRepository(Recruitworkingexperience001mb) private readonly experienceLetterRepository: Repository<Recruitworkingexperience001mb>,
        @InjectRepository(Recruitworkingexperience001hb) private readonly experienceLetterhbRepository: Repository<Recruitworkingexperience001hb>) { }
    ...
    async remove(id: number): Promise<void> {
        let experienceLetter = this.experienceLetterRepository.findOne(id);
        let recruitworkingexperience001hb = new Recruitworkingexperience001hb();
        recruitworkingexperience001hb.setProperties((await experienceLetter));
        this.experienceLetterhbRepository.save(recruitworkingexperience001hb);
        await this.experienceLetterRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/experienceLetter.html", "utf8");
