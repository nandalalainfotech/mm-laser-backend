...
export class EmpDeptService {
    constructor(@InjectRepository(Department001mb) private readonly empdeptRepository: Repository<Department001mb>,
        @InjectRepository(Department001hb) private readonly empdepthpRepository: Repository<Department001hb>) { }
    ...
    async remove(id: number): Promise<void> {
        let department = this.empdeptRepository.findOne(id);
        let department001hb = new Department001hb();
        department001hb.setProperties((await department));
        this.empdepthpRepository.save(department001hb);
