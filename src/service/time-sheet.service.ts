...
export class TimeSheetService {
	constructor(@InjectRepository(Dailytimesheet001hb) private readonly timeSheethbRepository: Repository<Dailytimesheet001hb>,
                @InjectRepository(Dailytimesheet001mb) private readonly timeSheetRepository: Repository<Dailytimesheet001mb>) { }
    ...
    async remove(id: number): Promise<void> {
        let dailytimesheet = this.timeSheetRepository.findOne(id);
        let dailytimesheet001hb = new Dailytimesheet001hb();
        dailytimesheet001hb.setProperties((await dailytimesheet));
        this.timeSheethbRepository.save(dailytimesheet001hb);
        await this.timeSheetRepository.delete(id);
    }

	async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/timeSheet.html", "utf8");
