...
@Injectable()
export class CrmRepLeadDetailsService {
    constructor(@InjectRepository(Leaddetail001mb) private readonly leaddetailsRepository: Repository<Leaddetail001mb>,
        @InjectRepository(Leaddetail001hb) private readonly leaddetailshbRepository: Repository<Leaddetail001hb>,) { }

    async create(leaddetailDTO: LeaddetailDTO): Promise<Leaddetail001mb> {
        const leaddetail001mb = new Leaddetail001mb();
        leaddetail001mb.setProperties(leaddetailDTO);
        return this.leaddetailsRepository.save(leaddetail001mb);
    }

    async update(leaddetailDTO: LeaddetailDTO): Promise<Leaddetail001mb> {
        const leaddetail001mb = new Leaddetail001mb();
        leaddetail001mb.setProperties(leaddetailDTO);
        await this.leaddetailsRepository.update({ leadId: leaddetail001mb.leadId }, leaddetail001mb);
        return leaddetail001mb;
    }

    async findAll(): Promise<Leaddetail001mb[]> {
        return this.leaddetailsRepository.find();
    }

    findOne(id: string): Promise<Leaddetail001mb> {
        return this.leaddetailsRepository.findOne(id);
    }

    async remove(id: string): Promise<void> {
        let Leaddetail = this.leaddetailsRepository.findOne(id);
        let leaddetail001hb = new Leaddetail001hb();
        leaddetail001hb.setProperties((await Leaddetail));
        this.leaddetailshbRepository.save(leaddetail001hb);
        await this.leaddetailsRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/leaddetails.html", "utf8");
        let leaddetails: any[] = await this.leaddetailsRepository.find();
        ...
        var document = {
            ...
            path: path.join(`./pdf/leaddetails.pdf`),
            type: "",
        };
        var options = {
            format: "A3",
        ...
        if (leaddetails.length < 0) {
            ...
            pdf.create(document, options).then((pathRes) => {
                ...
                response.writeHead(200, {
                    "Content-Disposition": "attachment;filename=" + "leaddetails.pdf",
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        let leaddetails = await this.leaddetailsRepository.find();
        ...
        if (leaddetails.length < 0) {
            ...
            let worksheet = workbook.addWorksheet('leaddetails');
            ...
            worksheet.getCell('A2:M2').value = "Add New Lead";
            ...
            worksheet.getCell('L3').value = "Lead Owner";
            ...
            worksheet.getCell('M3').value = "Territory";
            ...
            for (let i = 0; i < leaddetails.length; i++) {
                ...
                worksheet.getCell('A' + temp).value = leaddetails[i].leadId;
                ...
                worksheet.getCell('B' + temp).value = leaddetails[i].leadName;
                ...
                worksheet.getCell('C' + temp).value = leaddetails[i].companyName;
                ...
                worksheet.getCell('D' + temp).value = leaddetails[i].status;
                ...
                worksheet.getCell('E' + temp).value = leaddetails[i].address;
                ...
                worksheet.getCell('F' + temp).value = leaddetails[i].state;
                ...
                worksheet.getCell('G' + temp).value = leaddetails[i].pinCode;
                ...
                worksheet.getCell('H' + temp).value = leaddetails[i].country;
                ...
                worksheet.getCell('I' + temp).value = leaddetails[i].phone;
                ...
                worksheet.getCell('J' + temp).value = leaddetails[i].mobileNo;
                ...
                worksheet.getCell('K' + temp).value = leaddetails[i].email;
                ...
                worksheet.getCell('L' + temp).value = leaddetails[i].leadOwner;
                ...
                worksheet.getCell('M' + temp).value = leaddetails[i].terName;
