...
export class AccountspayableService {
    constructor(@InjectRepository(Accountspayable001mb) private readonly accountspayableRepository: Repository<Accountspayable001mb>,
        @InjectRepository(Accountspayable001hb) private readonly accountspayablehbRepository: Repository<Accountspayable001hb>,) { }
    ...
    async remove(id: string): Promise<void> {
        let accountspayable = this.accountspayableRepository.findOne(id);
        let accountspayable001hb = new Accountspayable001hb();
        accountspayable001hb.setProperties((await accountspayable));
        this.accountspayablehbRepository.save(accountspayable001hb);
        await this.accountspayableRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/accountspayable.html", "utf8");
        let accountspayable: any[] = await this.accountspayableRepository.find();
        ...
        var document = {
            ...
            path: path.join(`./pdf/accountspayable.pdf`),
            type: "",
        };
        var options = {
            format: "A3",
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        let accountspayable = await this.accountspayableRepository.find();
        ...
        if (accountspayable.length < 0) {
            ...
            let worksheet = workbook.addWorksheet('accountspayable');
            ...
            worksheet.getCell('A2:S2').value = "Accounts Payable";
            ...
            for (let i = 0; i < accountspayable.length; i++) {

                let temp = i + 4;

                worksheet.mergeCells('A' + temp);
                worksheet.getCell('A' + temp).value = accountspayable[i].id;
                ...
                worksheet.getCell('B' + temp).value = accountspayable[i].postingdate;
                ...
                worksheet.getCell('C' + temp).value = accountspayable[i].supplier;
                ...
                worksheet.getCell('D' + temp).value = accountspayable[i].suppliertype;
                ...
                worksheet.getCell('E' + temp).value = accountspayable[i].vouchertype;
                ...
                worksheet.getCell('F' + temp).value = accountspayable[i].vouchernumber;
                ...
                worksheet.getCell('G' + temp).value = accountspayable[i].duedate;
                ...
                worksheet.getCell('H' + temp).value = accountspayable[i].billno;
                ...
                worksheet.getCell('I' + temp).value = accountspayable[i].billdate;
                ...
                worksheet.getCell('J' + temp).value = accountspayable[i].invoicedamount;
                ...
                worksheet.getCell('K' + temp).value = accountspayable[i].paidamount;
                ...
                worksheet.getCell('L' + temp).value = accountspayable[i].outstandingamount;
                ...
                worksheet.getCell('M' + temp).value = accountspayable[i].age;
                ...
                worksheet.getCell('N' + temp).value = accountspayable[i].uptothirty;
                ...
                worksheet.getCell('O' + temp).value = accountspayable[i].uptosixty;
                ...
                worksheet.getCell('P' + temp).value = accountspayable[i].uptoninety;
                ...
                worksheet.getCell('Q' + temp).value = accountspayable[i].ninetyabove;
                ...
                worksheet.getCell('R' + temp).value = accountspayable[i].currency;
                ...
                worksheet.getCell('S' + temp).value = accountspayable[i].remarks;
