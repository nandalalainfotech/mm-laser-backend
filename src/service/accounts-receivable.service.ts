...
export class AccountsreceivableService {
    constructor(@InjectRepository(Accountsreceivable001mb) private readonly accountsreceivableRepository: Repository<Accountsreceivable001mb>,
        @InjectRepository(Accountsreceivable001hb) private readonly accountsreceivablehbRepository: Repository<Accountsreceivable001hb>,) { }
    ...
    async create(accountsreceivableDTO: AccountsreceivableDTO): Promise<Accountsreceivable001mb> {
        ...
        return this.accountsreceivableRepository.save(accountsreceivable001mb);
    }

    async update(accountsreceivableDTO: AccountsreceivableDTO): Promise<Accountsreceivable001mb> {
        const accountsreceivable001mb = new Accountsreceivable001mb();
        accountsreceivable001mb.setProperties(accountsreceivableDTO);
        await this.accountsreceivableRepository.update({ id: accountsreceivable001mb.id }, accountsreceivable001mb);
    ...
    findOne(id: number): Promise<Accountsreceivable001mb> {
        return this.accountsreceivableRepository.findOne(id);
    }

    async remove(id: string): Promise<void> {
        let accountsreceivable = this.accountsreceivableRepository.findOne(id);
        let accountsreceivable001hb = new Accountsreceivable001hb();
        accountsreceivable001hb.setProperties((await accountsreceivable));
        this.accountsreceivablehbRepository.save(accountsreceivable001hb);
        await this.accountsreceivableRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/accounts-receivable.html", "utf8");
        let accountsreceivable: any[] = await this.accountsreceivableRepository.find();
        ...
        var document = {
            ...
            path: path.join(`./pdf/accountsreceivable.pdf`),
            type: "",
        };
        var options = {
            format: "A3",
        ...
        if (accountsreceivable.length < 0) {
            ...
            pdf.create(document, options).then((pathRes) => {
                ...
                response.writeHead(200, {
                    "Content-Disposition": "attachment;filename=" + "accountsreceivable.pdf",
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        let accountsreceivable = await this.accountsreceivableRepository.find();
        ...
        if (accountsreceivable.length < 0) {
            ...
            let worksheet = workbook.addWorksheet('accountsreceivable');
            ...
            worksheet.getCell('A2:Q2').value = "Accounts Receivable";
            ...
            for (let i = 0; i < accountsreceivable.length; i++) {

                let temp = i + 4;

                worksheet.mergeCells('A' + temp);
                worksheet.getCell('A' + temp).value = accountsreceivable[i].id;
                ...
                worksheet.getCell('B' + temp).value = accountsreceivable[i].customer;
                ...
                worksheet.getCell('C' + temp).value = accountsreceivable[i].outstandingamount;
                ...
                worksheet.getCell('D' + temp).value = accountsreceivable[i].postingdate;
                ...
                worksheet.getCell('E' + temp).value = accountsreceivable[i].duedate;
                ...
                worksheet.getCell('F' + temp).value = accountsreceivable[i].vouchertype;
                ...
                worksheet.getCell('G' + temp).value = accountsreceivable[i].voucherno;
                ...
                worksheet.getCell('H' + temp).value = accountsreceivable[i].invoicedamount;
                ...
                worksheet.getCell('I' + temp).value = accountsreceivable[i].paidamount;
                ...
                worksheet.getCell('J' + temp).value = accountsreceivable[i].age;
                ...
                worksheet.getCell('K' + temp).value = accountsreceivable[i].uptothirty;
                ...
                worksheet.getCell('L' + temp).value = accountsreceivable[i].uptosixty;
                ...
                worksheet.getCell('M' + temp).value = accountsreceivable[i].uptoninety;
                ...
                worksheet.getCell('N' + temp).value = accountsreceivable[i].ninetyabove;
                ...
                worksheet.getCell('O' + temp).value = accountsreceivable[i].currency;
                ...
                worksheet.getCell('P' + temp).value = accountsreceivable[i].territory;
                ...
                worksheet.getCell('Q' + temp).value = accountsreceivable[i].remarks;
