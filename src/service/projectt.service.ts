...
export class ProjecttService {
    ...
    constructor (@InjectRepository(Project001hb) private readonly projectthbRepository: Repository<Project001hb>,
                 @InjectRepository(Project001mb) private readonly projecttRepository: Repository<Project001mb>) {}
    ...
    async remove(id: number): Promise<void> {
        let project = this.projecttRepository.findOne(id);
        let project001hb = new Project001hb();
        project001hb.setProperties((await project));
        this.projecttRepository.save(project001hb);
        await this.projecttRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/projectt.html", "utf8");
