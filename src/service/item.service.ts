...
export class Itemservice {
  constructor(
    ...
    private readonly itemRepository: Repository<Itemdt001mb>,
    @InjectRepository(Itemdt001hb)
    private readonly itemhbRepository: Repository<Itemdt001hb>
  ) {}
  ...
  async remove(id: string): Promise<void> {
    ...
    itemdt001hb.setProperties(await item);
    this.itemhbRepository.save(itemdt001hb);
    await this.itemRepository.delete(id);
  }

  async downloadPdf(@Req() request: Request, @Res() response: Response) {
    var html = fs.readFileSync("./html_pdf/item.html", "utf8");
