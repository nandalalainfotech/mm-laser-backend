...
export class ShippingRuleService {
	constructor(@InjectRepository(Shippingrule001hb) private readonly shipRulehbRepository: Repository<Shippingrule001hb>,
                @InjectRepository(Shippingrule001mb) private readonly shipRuleRepository: Repository<Shippingrule001mb>,) { }
    ...
    async remove(id: number): Promise<void> {
        let shippingrule = this.shipRuleRepository.findOne(id);
        let shippingrule001hb = new Shippingrule001hb();
        shippingrule001hb.setProperties((await shippingrule));
        this.shipRulehbRepository.save(shippingrule001hb);
        await this.shipRuleRepository.delete(id);
    }

	async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/shipping-rule.html", "utf8");
