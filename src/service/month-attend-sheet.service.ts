...
export class MonthlyAttendSheetService {
  constructor(
    @InjectRepository(Monthlyattendsheet001mb)
    private readonly monthlyAttendSheetRepository: Repository<Monthlyattendsheet001mb>,
    @InjectRepository(Monthlyattendsheet001hb)
    private readonly monthlyAttendSheethbRepository: Repository<Monthlyattendsheet001hb>
  ) {}

  async create(
    monthlyattendsheetDTO: MonthlyattendsheetDTO
  ): Promise<Monthlyattendsheet001mb> {
  ...
  async update(
    ...
    const monthlyattendsheet001mb = new Monthlyattendsheet001mb();
    monthlyattendsheet001mb.setProperties(monthlyattendsheetDTO);
    await this.monthlyAttendSheetRepository.update(
      { atsId: monthlyattendsheet001mb.atsId },
      monthlyattendsheet001mb
    );
  ...
  async remove(id: number): Promise<void> {
    let monthlyAttendSheet = this.monthlyAttendSheetRepository.findOne(id);
    let monthlyattendsheet001hb = new Monthlyattendsheet001hb();
    monthlyattendsheet001hb.setProperties(await monthlyAttendSheet);
    this.monthlyAttendSheethbRepository.save(monthlyattendsheet001hb);
    await this.monthlyAttendSheetRepository.delete(id);
  }

  async downloadPdf(@Req() request: Request, @Res() response: Response) {
    var html = fs.readFileSync("./html_pdf/monthlyAttendSheet.html", "utf8");
    let monthlyAttendSheet: any[] =
      await this.monthlyAttendSheetRepository.find();
      ...
      pdf
        ...
        .then((pathRes) => {
          ...
          response.writeHead(200, {
            "Content-Disposition":
              "attachment;filename=" + "monthlyAttendSheet.pdf",
  ...
  async downloadExcel(@Req() request: Request, @Res() response: Response) {
    ...
    if (monthlyAttendSheet.length < 0) {
      ...
      worksheet.getCell("A1:AO1").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("A2:AO2").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AH3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AJ3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AK3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AL3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AM3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AN3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      worksheet.getCell("AO3").alignment = {
        vertical: "middle",
        horizontal: "center",
      };
      ...
      for (let i = 0; i < monthlyAttendSheet.length; i++) {
        ...
        worksheet.getCell("AC" + temp).value =
          monthlyAttendSheet[i].twentyone21;
        ...
        worksheet.getCell("AD" + temp).value =
          monthlyAttendSheet[i].twentytwo22;
        ...
        worksheet.getCell("AE" + temp).value =
          monthlyAttendSheet[i].twentythree23;
        ...
        worksheet.getCell("AF" + temp).value =
          monthlyAttendSheet[i].twentyfour24;
        ...
        worksheet.getCell("AG" + temp).value =
          monthlyAttendSheet[i].twentyfive25;
        ...
        worksheet.getCell("AH" + temp).value =
          monthlyAttendSheet[i].twentysix26;
        worksheet.getCell("AH" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AH" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AI" + temp);
        worksheet.getCell("AI" + temp).value =
          monthlyAttendSheet[i].twentyseven27;
        worksheet.getCell("AI" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AI" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AJ" + temp);
        worksheet.getCell("AJ" + temp).value =
          monthlyAttendSheet[i].twentyeight28;
        worksheet.getCell("AJ" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AJ" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AK" + temp);
        worksheet.getCell("AK" + temp).value =
          monthlyAttendSheet[i].twentynine29;
        worksheet.getCell("AK" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AK" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };
        ...
        worksheet.getCell("AL" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AM" + temp);
        worksheet.getCell("AM" + temp).value =
          monthlyAttendSheet[i].totalPresent;
        worksheet.getCell("AM" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AM" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };

        worksheet.mergeCells("AN" + temp);
        worksheet.getCell("AN" + temp).value =
          monthlyAttendSheet[i].totalAbsent;
        worksheet.getCell("AN" + temp).font = {
          size: 11,
          bold: true,
        };
        worksheet.getCell("AN" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };
        ...
        worksheet.getCell("AO" + temp).alignment = {
          vertical: "middle",
          horizontal: "center",
        };
      }
