...
export class CustomerDetailService {
    ...
    constructor(@InjectRepository(Customerdetails001mb) private readonly customerdetailRepository: Repository<Customerdetails001mb>,
        @InjectRepository(Customerdetails001hb) private readonly customerdetailhbRepository: Repository<Customerdetails001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let Customerdetails = this.customerdetailRepository.findOne(id);
        let customerdetails001hb = new Customerdetails001hb();
        customerdetails001hb.setProperties((await Customerdetails));
        this.customerdetailhbRepository.save(customerdetails001hb);
        await this.customerdetailRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/customerdetail.html", "utf8");
