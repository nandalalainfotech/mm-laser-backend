...
export class AssetMovementService {
    constructor(@InjectRepository(Assetmovement001mb) private readonly assetMovementRepository: Repository<Assetmovement001mb>,
        @InjectRepository(Assetmovement001hb) private readonly assetMovementhbRepository: Repository<Assetmovement001hb>,) { }
    ...
    async remove(id: number): Promise<void> {
        let assetMovement = this.assetMovementRepository.findOne(id);
        let assetmovement001hb = new Assetmovement001hb();
        assetmovement001hb.setProperties((await assetMovement));
        this.assetMovementhbRepository.save(assetmovement001hb);
        await this.assetMovementRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/assetMovement.html", "utf8");
