...
export class WareHouseService {
    ...
    @InjectRepository(Warehouse001hb) private readonly wareHousehbRepository: Repository<Warehouse001mb>) { }
    ...
    async remove(id: number): Promise<void> {
        let Warehouse = this.wareHouseRepository.findOne(id);
        let warehouse001hb = new Warehouse001hb();
        warehouse001hb.setProperties((await Warehouse));
        this.wareHousehbRepository.save(warehouse001hb);
        await this.wareHouseRepository.delete(id);
    }
    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/wareHouse.html", "utf8");
