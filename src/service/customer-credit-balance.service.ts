...
export class Balanceservice {
    ...
    constructor(@InjectRepository(Customercreditbalance001mb) private readonly balanceRepository: Repository<Customercreditbalance001mb>,
        @InjectRepository(Customercreditbalance001hb) private readonly balancehbRepository: Repository<Customercreditbalance001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let Customercreditbalance = this.balanceRepository.findOne(id);
        let customercreditbalance001hb = new Customercreditbalance001hb();
        customercreditbalance001hb.setProperties((await Customercreditbalance));
        this.balancehbRepository.save(customercreditbalance001hb);
        await this.balanceRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/balance.html", "utf8");
