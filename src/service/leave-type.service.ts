...
export class LeaveTypeService {
  constructor(
    @InjectRepository(Leavetype001mb)
    private readonly leaveTypeRepository: Repository<Leavetype001mb>,
    @InjectRepository(Leavetype001hb)
    private readonly leaveTypehbRepository: Repository<Leavetype001hb>
  ) {}
  ...
  async update(leavetypeDTO: LeavetypeDTO): Promise<Leavetype001mb> {
    const leavetype001mb = new Leavetype001mb();
    leavetype001mb.setProperties(leavetypeDTO);
    await this.leaveTypeRepository.update(
      { lvtypeId: leavetype001mb.lvtypeId },
      leavetype001mb
    );
  ...
  async downloadPdf(@Req() request: Request, @Res() response: Response) {
    var html = fs.readFileSync("./html_pdf/leaveType.html", "utf8");
