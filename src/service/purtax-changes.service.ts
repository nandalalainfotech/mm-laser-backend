...
export class PurTaxChangesService {
	constructor(@InjectRepository(Purtaxcharges001hb) private readonly purtaxchangeshbRepository: Repository<Purtaxcharges001hb>,
                @InjectRepository(Purtaxcharges001mb) private readonly purtaxchangesRepository: Repository<Purtaxcharges001mb>,) { }
    ...
    async remove(id: number): Promise<void> {
        let purtaxcharges = this.purtaxchangesRepository.findOne(id);
        let purtaxcharges001hb = new Purtaxcharges001hb();
        purtaxcharges001hb.setProperties((await purtaxcharges));
        this.purtaxchangeshbRepository.save(purtaxcharges001hb);
        await this.purtaxchangesRepository.delete(id);
    }

	async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/purtaxcharges.html", "utf8");
