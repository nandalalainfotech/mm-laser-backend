...
export class CrmSalesPipelineService {
    ...
    constructor(@InjectRepository(Crmsplead001mb) private readonly crmSalesRepository: Repository<Crmsplead001mb>,
        @InjectRepository(Crmsplead001hb) private readonly crmSaleshbRepository: Repository<Crmsplead001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let Crmsplead = this.crmSalesRepository.findOne(id);
        let crmsplead001hb = new Crmsplead001hb();
        crmsplead001hb.setProperties((await Crmsplead));
        this.crmSaleshbRepository.save(crmsplead001hb);
        await this.crmSalesRepository.delete(id);
    }


    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/crmSales.html", "utf8");
