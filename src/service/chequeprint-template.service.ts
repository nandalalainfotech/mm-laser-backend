...
export class ChequeprintTemplateService {
    constructor(@InjectRepository(Chequetemplate001mb) private readonly chequeprintTemplateRepository: Repository<Chequetemplate001mb>,
        @InjectRepository(Chequetemplate001hb) private readonly chequeprintTemplatehbRepository: Repository<Chequetemplate001hb>,) { }
    ...
    async remove(id: string): Promise<void> {
        let chequeprintTemplate = this.chequeprintTemplateRepository.findOne(id);
        let chequetemplate001hb = new Chequetemplate001hb();
        chequetemplate001hb.setProperties((await chequeprintTemplate));
        this.chequeprintTemplatehbRepository.save(chequetemplate001hb);
        await this.chequeprintTemplateRepository.delete(id);
    }
    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/chequeprintTemplate.html", "utf8");
