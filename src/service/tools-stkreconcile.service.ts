...
export class ToolsStkReconcileService {
    constructor(@InjectRepository(Stkreconcile001hb) private readonly stkreconcilehbRepository: Repository<Stkreconcile001hb>,
                @InjectRepository(Stkreconcile001mb) private readonly stkreconcileRepository: Repository<Stkreconcile001mb>,) { }
    ...
    async remove(id: number): Promise<void> {
        let stkreconcile = this.stkreconcileRepository.findOne(id);
        let stkreconcile001hb = new Stkreconcile001hb();
        stkreconcile001hb.setProperties((await stkreconcile));
        this.stkreconcilehbRepository.save(stkreconcile001hb);
        await this.stkreconcileRepository.delete(id);
    }
    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/stkreconcile.html", "utf8");
