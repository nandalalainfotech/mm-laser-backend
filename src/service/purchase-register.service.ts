...
export class PurchaseRegisterService {
    constructor(@InjectRepository(Purchaseregister001hb) private readonly purchaseRegisterhbRepository: Repository<Purchaseregister001hb>,
                @InjectRepository(Purchaseregister001mb) private readonly purchaseRegisterRepository: Repository<Purchaseregister001mb>,) { }

    async create(purchaseregisterDTO: PurchaseregisterDTO): Promise<Purchaseregister001mb> {
        const purchaseregister001mb = new Purchaseregister001mb();
        purchaseregister001mb.setProperties(purchaseregisterDTO);
        return this.purchaseRegisterRepository.save(purchaseregister001mb);
    }

    async update(purchaseregisterDTO: PurchaseregisterDTO): Promise<Purchaseregister001mb> {
        const purchaseregister001mb = new Purchaseregister001mb();
        purchaseregister001mb.setProperties(purchaseregisterDTO);
        await this.purchaseRegisterRepository.update({ regId: purchaseregister001mb.regId }, purchaseregister001mb);
        return purchaseregister001mb;
    }

    async findAll(): Promise<Purchaseregister001mb[]> {
        return this.purchaseRegisterRepository.find();
    }

    findOne(id: string): Promise<Purchaseregister001mb> {
        return this.purchaseRegisterRepository.findOne(id);
    }

    async remove(id: number): Promise<void> {
        let purchaseregister = this.purchaseRegisterRepository.findOne(id);
        let purchaseregister001hb = new Purchaseregister001hb();
        purchaseregister001hb.setProperties((await purchaseregister));
        this.purchaseRegisterhbRepository.save(purchaseregister001hb);
        await this.purchaseRegisterRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/purchaseRegister.html", "utf8");
        let purchaseRegister: any[] = await this.purchaseRegisterRepository.find();
        ...
        var document = {
            ...
            path: path.join(`./pdf/purchaseRegister.pdf`),
            type: "",
        };
        var options = {
            format: "A3",
        ...
        if (purchaseRegister.length < 0) {
            ...
            pdf.create(document, options).then((pathRes) => {
                ...
                response.writeHead(200, {
                    "Content-Disposition": "attachment;filename=" + "purchaseRegister.pdf",
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        let purchaseRegister = await this.purchaseRegisterRepository.find();
        ...
        if (purchaseRegister.length < 0) {
            ...
            let worksheet = workbook.addWorksheet('purchaseRegister');
            ...
            { key: 'T', width: 20.0 },{ key: 'U', width: 20.0 },{ key: 'V', width: 20.0 }];
            ...
            worksheet.getCell('A1:V1').value = "NANDALALA ERP";
            worksheet.getCell('A1:V1').font = {
                size: 20,
                bold: true
            };
            worksheet.getCell('A1:V1').fill = {
                type: 'pattern', pattern: 'solid', fgColor:
                    { argb: 'ffffff' }, bgColor: { argb: '#7f11e0' }
            };
            worksheet.getCell('A1:V1').alignment = { vertical: 'middle', horizontal: 'center' };

            worksheet.mergeCells('A2:V2');
            worksheet.getCell('A2:V2').value = "Purchase Register";
            worksheet.getCell('A2:V2').font = {
                size: 16,
                bold: true
            };
            worksheet.getCell('A2:V2').alignment = { vertical: 'middle', horizontal: 'center' };
            ...
            worksheet.getCell('C3').value = "Invoice";
            ...
            worksheet.getCell('D3').value = "Supplier";
            ...
            worksheet.getCell('E3').value = "Supplier Type";
            ...
            worksheet.getCell('I3').value = "Bill Number";
            ...
            worksheet.getCell('J3').value = "Bill Date";
            ...
            worksheet.getCell('K3').value = "Purchase Order";
            ...
            worksheet.getCell('L3').value = "Purchase Receipt";
            ...
            worksheet.getCell('M3').value = "Currency";
            ...
            worksheet.getCell('N3').value = "Furnitures Count";
            ...
            worksheet.getCell('O3').value = "Softwares Count";
            ...
            worksheet.getCell('P3').value = "Stock Balance";
            ...
            worksheet.getCell('Q3').value = "Net Total";
            ...
            worksheet.getCell('R3').value = "Total Tax";
            ...
            worksheet.getCell('S3').value = "Grand Total";
            ...
            worksheet.getCell('T3').value = "Rounded Total";
            ...
            worksheet.getCell('U3').value = "OutstandingAmt";
            ...
            worksheet.getCell('V3').value = "Remarks";
            ...
            for (let i = 0; i < purchaseRegister.length; i++) {

                let temp = i + 4;
                
                worksheet.mergeCells('A' + temp);
                worksheet.getCell('A' + temp).value = purchaseRegister[i].regId;
                ...
                worksheet.getCell('B' + temp).value = purchaseRegister[i].postingDate;
                ...
                worksheet.getCell('C' + temp).value = purchaseRegister[i].invoice;
                ...
                worksheet.getCell('D' + temp).value = purchaseRegister[i].supName;
                ...
                worksheet.getCell('E' + temp).value = purchaseRegister[i].supType;
                ...
                worksheet.getCell('F' + temp).value = purchaseRegister[i].accountType;
                ...
                worksheet.getCell('G' + temp).value = purchaseRegister[i].paymentMode;
                ...
                worksheet.getCell('H' + temp).value = purchaseRegister[i].projectname;
                ...
                worksheet.getCell('I' + temp).value = purchaseRegister[i].billNo;
                ...
                worksheet.getCell('J' + temp).value = purchaseRegister[i].billDate;
                ...
                worksheet.getCell('K' + temp).value = purchaseRegister[i].poSeries;
                ...
                worksheet.getCell('L' + temp).value = purchaseRegister[i].purecpt;
                ...
                worksheet.getCell('M' + temp).value = purchaseRegister[i].currency;
                ...
                worksheet.getCell('N' + temp).value = purchaseRegister[i].furnituresCount;
                ...
                worksheet.getCell('O' + temp).value = purchaseRegister[i].softwaresCount;
                ...
                worksheet.getCell('P' + temp).value = purchaseRegister[i].stkrecBalance;
                ...
                worksheet.getCell('Q' + temp).value = purchaseRegister[i].netTotal;
                ...
                worksheet.getCell('R' + temp).value = purchaseRegister[i].totalTax;
                ...
                worksheet.getCell('S' + temp).value = purchaseRegister[i].grandTotal;
                ...
                worksheet.getCell('T' + temp).value = purchaseRegister[i].roundTotal;
                ...
                worksheet.getCell('U' + temp).value = purchaseRegister[i].outstandAmt;
                ...
                worksheet.getCell('V' + temp).value = purchaseRegister[i].remarks;
