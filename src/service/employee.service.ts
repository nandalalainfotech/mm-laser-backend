...
export class
    ...
    constructor(@InjectRepository(Employee001mb) private readonly employeeRepository: Repository<Employee001mb>,
        @InjectRepository(Employee001hb) private readonly employeehbRepository: Repository<Employee001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        ...
        let employee001hb = new Employee001hb();
        employee001hb.setProperties((await employee));
        this.employeehbRepository.save(employee001hb);
        await this.employeeRepository.delete(id);
    }
    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/employee.html", "utf8");
