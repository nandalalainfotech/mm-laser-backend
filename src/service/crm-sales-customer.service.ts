...
export class CrmSalesCustomerService {
    ...
    constructor(@InjectRepository(Crmspcust001mb) private readonly crmCustomerRepository: Repository<Crmspcust001mb>,
        @InjectRepository(Crmspcust001hb) private readonly crmCustomerhbRepository: Repository<Crmspcust001hb>) { }
    ...
    async remove(id: string): Promise<void> {
        let Crmspcust = this.crmCustomerRepository.findOne(id);
        let crmspcust001hb = new Crmspcust001hb();
        crmspcust001hb.setProperties((await Crmspcust));
        this.crmCustomerhbRepository.save(crmspcust001hb);
        await this.crmCustomerRepository.delete(id);
    }

    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        var html = fs.readFileSync("./html_pdf/crmCustomer.html", "utf8");
